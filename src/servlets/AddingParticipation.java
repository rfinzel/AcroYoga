 ...
 */
@WebServlet("/AddParticipation")
public class AddingParticipation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddingParticipation() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Post hinzufügen
		pDAO.addParticipation(new Participation(0, formatDate(request.getParameter("nextEvent")), Integer.parseInt(request.getParameter("eventId")), mDAO.getMemberById(Integer.parseInt(request.getSession().getAttribute("id").toString()))));
